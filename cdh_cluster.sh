...
docker run -d --net cloudera_network --net-alias cloudera-yarn -p 8088:8088 -p 8032:8032 dfossouo/cloudera-yarn:5.9.0

#5. Start DataNode

docker run -d --net cloudera_network --net-alias cloudera-datanode -h cloudera-datanode --link cloudera-namenode --link cloudera-yarn -p 50020:50020 -p 50075:50075 -p 8042:8042 dfossouo/cloudera-datanode:5.9.0 
