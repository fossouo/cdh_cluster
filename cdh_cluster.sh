...
docker run -d --net cloudera_network --net-alias cloudera-datanode -h cloudera-datanode --link cloudera-namenode --link yarnmaster -p 50020:50020 -p 50075:50075 -p 8042:8042 dfossouo/cloudera-datanode:5.9.0 

#6. Launch Edge Node

docker run -ti --net cloudera_network --net-alias cloudera-edge --link cloudera-namenode --link cloudera-yarnmaster dfossouo/cloudera-edge:5.9.0 bash
